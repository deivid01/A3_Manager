...
const api: A3Api = {
  ...
  updateUser: (id, input) => call(ipcChannels.updateUser, id, input),
  ...
  archiveRental: (id) => call(ipcChannels.archiveRental, id),
  unarchiveRental: (id) => call(ipcChannels.unarchiveRental, id),
  saveRentalPdf: (id) => call(ipcChannels.saveRentalPdf, id),
  printRental: (id, origin) => call(ipcChannels.printRental, id, origin),
